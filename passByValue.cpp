/*	Engineer: Janneth Guarcas Garcia		    
	Assignment: Programming Assignment 6 (part 1/3)
	Date: 4/24/18
	Description: passByValue.cpp
	...
	Use functions to perform each item. The functions must use pass by 
	value, pass by reference, or pass by pointer."          
*/
...
int main()
{
	int value1, value2, value3, low, mid, high;
    cout << "Enter 3 different integers: ";
	cin >> value1 >> value2 >> value3;
	bool continueAlong = validateValues(value1, value2, value3);
	if (continueAlong)
		{
		low = findMin(value1, value2, value3);
		high = findMax(value1, value2, value3);
		mid = isMid(low, high, value1, value2, value3);
